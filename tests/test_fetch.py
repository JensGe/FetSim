...
def generate_test_frontier_list():
    return {
...
def test_simulate_fetch():
    ...
    assert len(processed_list["urls"]) >= 1


def test_get_list_of_urls():

    url_list = fetch.get_list_of_urls(generate_test_frontier_list())
    asserted_url_list = [
        "http://www.abc.de/html/index",
        "http://www.abc.de/html/contact",
        "http://www.abc.de/html/start.html",
        "http://www.abc.de/html/people.html",
        "http://www.bac.com/html/mission",
        "http://www.bac.com/blue",
        "http://www.abc.com/html/index",
        "http://www.abc.com/html/contact",
    ]
    assert url_list == asserted_url_list
